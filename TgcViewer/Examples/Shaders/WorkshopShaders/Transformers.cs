...
namespace Examples.Shaders.WorkshopShaders
{
    ...
    // menu item
    public class menu_item : gui_item
    {
        public Vector3 pos_imagen = new Vector3(500, 60, 0);
    ...
    public class menu_item2 : gui_item
    {
    ...
    // static text
    public class static_text: gui_item
    {
    ...
    public class Transformers: TgcExample
    {
        string MyMediaDir;
        string MyShaderDir;
