...
namespace Examples.Shaders.WorkshopShaders
{
    ...
    public class Distorsiones : TgcExample
    {
        string MyMediaDir;
        string MyShaderDir;
        List<TgcMesh> meshes;
        ...
        {
            return "Workshop-Distorsionador";
        }

        public override string getDescription()
        {
            return "Distorsionadores";
        }
        ...
        public override void init()
        {
            ...
            GuiController.Instance.Modifiers.addEnum("distorcionador", typeof(Distorciones), Distorciones.Pincushion);
            GuiController.Instance.Modifiers.addBoolean("grid","mostrar grilla", false);
            GuiController.Instance.Modifiers.addFloat("Ku", 0, 1, 0.1f);
            GuiController.Instance.Modifiers.addFloat("Kv", 0, 1, 0.1f);

            GuiController.Instance.Modifiers.addFloat("oc_scale_in", 0.1f, 4, 2.5f);
            GuiController.Instance.Modifiers.addFloat("oc_scale", 0.01f, 1f, 0.35f);
        ...
        public override void render(float elapsedTime)
        {
            ...
            int distorcionador = (int)GuiController.Instance.Modifiers["distorcionador"];
            ...
            effect.SetValue("fish_kU", (float)GuiController.Instance.Modifiers["Ku"]);
            effect.SetValue("fish_kV", (float)GuiController.Instance.Modifiers["Kv"]);
            effect.SetValue("grid", (bool)GuiController.Instance.Modifiers["grid"]);
            effect.SetValue("ScaleIn", (float)GuiController.Instance.Modifiers["oc_scale_in"]);
            effect.SetValue("Scale", (float)GuiController.Instance.Modifiers["oc_scale"]);
